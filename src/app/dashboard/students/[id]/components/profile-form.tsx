        ...
        <CardContent className="space-y-6">
           <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
              <div className="space-y-2">
                ...
                <Input id="emergency-contact-name" defaultValue={student.emergencyContacts[0]?.name} />
              </div>
              <div className="space-y-2">
                <Label htmlFor="emergency-contact-phone">Telefone</Label>
                <Input id="emergency-contact-phone" defaultValue={student.emergencyContacts[0]?.phone} />
              </div>
              <div className="space-y-2">
                <Label htmlFor="emergency-contact-relationship">Relação</Label>
                <Input id="emergency-contact-relationship" defaultValue={student.emergencyContacts[0]?.relationship} />
              </div>
           </div>
        </CardContent>
      </Card>
        ...
        <CardContent className="space-y-6">
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
                ...
                <div className="flex items-center space-x-2 pt-8">
                 ...
                 <div className="space-y-2">
                  <Label htmlFor="fikm-fee-date">Data Pag. FIKM</Label>
                  <Input id="fikm-fee-date" type="date" defaultValue={student.fikmFeePaidDate} />
                </div>
            </div>
